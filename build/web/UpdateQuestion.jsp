...
<center>
    <div style="width:1000px;height: 650px; background-color:light; border: 2px solid brown;">
        <h1 style="color:brown;" ><u>Update Question</u>
            <form action="SearchQuestionResult.jsp">
                <table width="600p" cellspacing="0" cellpadding="5" border="1">
                    <tr>  <td width="200">Question ID</td>
                     <td><input type="number" name="qid" style="width:400px;height: 40px;"></td></tr>
                    <tr>  <th><input type="submit" style="width:150px;height: 40px; background-color: red; "></th><th>
